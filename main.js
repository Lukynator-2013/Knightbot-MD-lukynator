...
global.channelLink = "https://whatsapp.com/channel/0029VbBceejGzzKMpY4c9P3l";
global.ytch = "https://youtube.com/@lukynator2013";
        ...
        if (message.message?.buttonsResponseMessage) {
            ...
            if (buttonId === 'channel') {
                await sock.sendMessage(chatId, {
                    text: '📢 *Připojte se na náš kanál:*\nhttps://whatsapp.com/channel/0029VbBceejGzzKMpY4c9P3l'
                }, { quoted: message });
                return;
                ...
                await sock.sendMessage(chatId, {
                    text: `🔗 *Komunita*\n\nhttps://chat.whatsapp.com/KBoUxRwJqBlC7L8M0o5koy`
                }, { quoted: message });
                return;
            }
        }
